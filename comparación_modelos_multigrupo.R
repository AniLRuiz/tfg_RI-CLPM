...
# academic.tfg = base de datos con medidas estandarizadas y variable
#                 grupal (Exam)
# compL = lista de comparaciones (compareFit)
# fitmeasL y paramsL = listas con los modelos en lavaan
...
# nombre indica los números de los modelos comparados
# 0 = modelo base (todos los parámetros son diferentes salvo medias)
